...
assert result == expected
``` 
Tu ne vérifies pas dans ton code si les mots de la liste sont bien des anagrammes des autres mots présent dans la liste. Si c'est le cas, tu dois l'ajouter dans une liste où se trouve ces anagrammes. Sinon, tu crée une nouvelle liste.